...
class MoveRobotActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new MoveRobotResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveRobotResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveRobotResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveRobotActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MoveRobotResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MoveRobotResult()
    }
...
module.exports = MoveRobotActionResult;
