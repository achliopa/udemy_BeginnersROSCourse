...
class MoveRobotActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MoveRobotFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveRobotFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveRobotActionFeedback(null);
    ...
    data.feedback = MoveRobotFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveRobotActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveRobotFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveRobotFeedback()
    }
...
module.exports = MoveRobotActionFeedback;
