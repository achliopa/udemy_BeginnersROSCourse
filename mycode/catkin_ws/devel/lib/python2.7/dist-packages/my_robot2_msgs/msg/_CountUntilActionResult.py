...
"""autogenerated by genpy from my_robot2_msgs/CountUntilActionResult.msg. Do not edit."""
import sys
...
class CountUntilActionResult(genpy.Message):
  ...
  _type = "my_robot2_msgs/CountUntilActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot2_msgs/CountUntilResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_robot2_msgs.msg.CountUntilResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot2_msgs.msg.CountUntilResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_q().pack(self.result.count))
